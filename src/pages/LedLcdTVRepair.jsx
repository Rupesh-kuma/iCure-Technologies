...
import servicedetails1 from "../assets/img/service/led1.jpeg";
import servicedetails2 from "../assets/img/service/led2.jpeg";
import servicedetails3 from "../assets/img/service/led3.jpeg";
const Ledcdtvrepair = () => {
    return (
        <>
            <>
                ...
                >
                    <div className="container">
                        <h2 className="breadcrumb-title">Led / Lcd TV Repair</h2>
                        <ul className="breadcrumb-menu">
                            <li>
                                <Link href="index-2.html">Home</Link>
                            </li>
                            <li className="active">Led / Lcd TV Repair</li>
                        </ul>
                    </div>
                </div>
                {/* breadcrumb end */}
                            ...
                            <div className="row">
                                ...
                                <div className="col-xl-8 col-lg-8">
                                    <div className="service-details">
                                        ...
                                        <div className="service-details">
                                            <h3 className="mb-30">Led / Lcd TV Repair</h3>
                                            <p className="mb-20">
                                            Modern LED and LCD TVs are complex electronic devices packed with delicate components and advanced display technologies. Over time, issues such as power failures, display problems, backlight faults, or sound malfunctions can occur due to aging parts, voltage fluctuations, or physical damage. At iCure Technologies, we specialize in diagnosing and repairing a wide range of LED and LCD TVs, helping our clients save on expensive replacements.

</p>
                                            <p className="mb-20">
                                            Our skilled technicians use state-of-the-art diagnostic tools and years of hands-on experience to identify and fix issues at the component level—restoring your TV to optimal performance. Whether it’s a power supply problem, no display, sound issues, or panel faults, we provide reliable and efficient repair solutions.
                                            ...
                                            <p className="mb-20">
                                            We know how important home entertainment is, which is why we focus on quick service delivery without compromising on repair quality.
